...
return new class extends Migration
{
    ...
    {
        Schema::create('location_electricty_factures', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId("state")
                ->nullable()
                ->constrained("stop_house_electricity_states", "id")
                ->onUpdate("CASCADE")
                ->onDelete("CASCADE");
    ...
    {
        Schema::dropIfExists('location_electricty_factures');
    }
};
