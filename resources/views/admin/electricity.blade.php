        ...
        <div class="modal fade" id="searchByPeriod" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('electricity',crypId($current_agency->id))}}" method="get">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                    ...
                    <table id="myTable" class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr class="align-items-center">
                                ...
                                <td class="text-center"> <span class=" bg-warning text-white">{{$location->Room?->electricity_counter_start_index}}</span> </td>
