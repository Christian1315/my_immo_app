<x-templates.base :title="'Recouvrement qualitatif'" :active="'recovery'" :agency="$agency">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6 text-center">
            ...
            <div class="" id="show_action_buttons" hidden>
                <div class="d-flex">
                    <a class="btn btn-sm btn-light shadow" href="{{route('taux._ShowAgencyTauxQualitatif_Simple',crypId($agency->id))}}"><i class="bi bi-house-dash"></i> Pour cette agence</a>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            <form action="{{route('recovery_qualitatif',crypId($agency->id))}}" method="get" class="shadow border p-3 rounded">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('taux._ShowAgencyTauxQualitatif_By_Supervisor',crypId($agency->id))}}" method="get">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('taux._ShowAgencyTauxQualitatif_By_House',crypId($agency->id))}}" method="get">
