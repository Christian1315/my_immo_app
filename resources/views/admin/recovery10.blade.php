<x-templates.base :title="'Recouvrement 10'" :active="'recovery'" :agency="$agency">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('taux._ShowAgencyTaux10_By_Supervisor',crypId($agency->id))}}" method="get">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('taux._ShowAgencyTaux10_By_House',crypId($agency->id))}}" method="get">
