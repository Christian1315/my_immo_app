...
<body class="antialiased bg-dots-darker relative">
    <div class="container-fluid shadow-lg bg-light header">
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand text-white btn roundered px-3" href="/"> <strong>IMMO</strong></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form class="d-flex" role="search">
                                <img src="logo.jpeg" width="100px" class="shadow-lg p-3 bg-body rounded" alt="" srcset="">
                            </form>
                        </div>
                    </div>
                </nav>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="title">Soyez les bienvenu sur l'API de IMMO</h1>
